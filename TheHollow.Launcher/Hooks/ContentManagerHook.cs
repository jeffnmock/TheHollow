...
namespace TheHollow.Launcher
{
    ...
    public class ContentManagerHook : ContentManager
    {
        ...
        public static IEnumerable<PlayerClass> AdditionalPlayerClasses()
        {
            List<PlayerClass> characters = new List<PlayerClass>(); 
        ...
        public void DumpSpriteLibrary(string assetName, string fileName)
        {
            ...
            foreach (var key in sl.Keys)
            {
                ...
                //    DrawOffset = sprite.get_DrawOffset(),
                //    FlipX = sprite.get_FlipX(),
                //    FlipY = sprite.get_FlipY(),
                //    Name = sprite.get_Name(),
                //    TextureFile = sprite.get_TextureAsset(),
                //    TextureRect = new ModRectangle
                //    {
                //        X = sprite.get_TextureRect().X,
                //        Y = sprite.get_TextureRect().Y,
                //        Height = sprite.get_TextureRect().Height,
                //        Width = sprite.get_TextureRect().Width
                //    }
                //};
